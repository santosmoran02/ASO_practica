...
/*
 *  Función auxiliar: guardar en disco la información persistente de un inodo nuevo
 */
void assoofs_add_inode_info(struct super_block *sb, struct assoofs_inode_info *inode) {
    struct assoofs_super_block_info *assoofs_sb;
    struct buffer_head *bh;
...
/*
 *  Función auxiliar: buscar la información persistente de un inodo concreto en el almacén
 */
struct assoofs_inode_info *assoofs_search_inode_info(struct super_block *sb, struct assoofs_inode_info *start, struct assoofs_inode_info *search) {
    uint64_t count = 0;
...
/*
 *  Función auxiliar: actualizar en disco la información persistente de un inodo
 */
int assoofs_save_inode_info(struct super_block *sb, struct assoofs_inode_info *inode_info) {
    struct buffer_head *bh;
